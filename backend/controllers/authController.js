...
const { sendSMSWithRetry } = require('../config/twilio');
const { formatPhoneNumberForTwilio } = require('../config/twilio');
...
const requestLoginOTP = async (req, res) => {
  try {
    ...
    const smsResult = await sendSMSWithRetry(formattedPhone, message);
